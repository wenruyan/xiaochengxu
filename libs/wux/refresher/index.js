...
baseComponent({
    ...
    methods: {
         ...
         */
        bindtouchstart(e) {
            if (this.isRefreshing() || this.isLoading() || !this.data.noRefreshing) return false
         ...
         */
        bindtouchmove(e) {
            if (!this.start || this.isRefreshing() || this.isLoading() || !this.data.noRefreshing) return false
        ...
        bindtouchend(e) {
            ...
            if (this.diffY <= 0 || this.isRefreshing() || this.isLoading() || !this.data.noRefreshing) return false
